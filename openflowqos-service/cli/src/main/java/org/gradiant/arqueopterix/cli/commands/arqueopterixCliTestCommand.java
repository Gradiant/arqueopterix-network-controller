 ...
 */
package org.gradiant.arqueopterix.cli.commands;
...
public class arqueopterixCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(arqueopterixCliTestCommand.class);
    protected final arqueopterixCliCommands service;

    public arqueopterixCliTestCommand(final arqueopterixCliCommands service) {
